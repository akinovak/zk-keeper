...
export function FullModalContent(props: {
    className?: string;
    children: ReactNode;
}): ReactElement {
    return (
        <div className={classNames('full-modal__content', props.className)}>
            {props.children}
        </div>
    )
}

export function FullModalFooter(props: {
    className?: string;
    children: ReactNode;
}): ReactElement {
    return (
        <div className={classNames('full-modal__footer', props.className)}>
            {props.children}
        </div>
    )
}
